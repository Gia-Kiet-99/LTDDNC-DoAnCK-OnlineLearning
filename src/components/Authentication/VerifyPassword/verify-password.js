...
const VerifyPassword = (props) => {
  return (
    <View style={styles.container}>
      ...
      <View>
        <TextInput secureTextEntry={true} placeholder='New password' selectionColor={'#888'}
                   style={textInputStyles.textInput}/>
      </View>
      <View>
        <TextInput secureTextEntry={true} placeholder='Confirm new password' selectionColor={'#888'}
                   style={textInputStyles.textInput}/>
      </View>
